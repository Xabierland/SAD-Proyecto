...
def lda():
    """
    Función para implementar el algoritmo lda.
    ...
    with tqdm(total=100, desc='Procesando LDA', unit='iter', leave=True) as pbar:
        gs = GridSearchCV(LinearDiscriminantAnalysis(), args.lda, cv=5, n_jobs=args.cpu, scoring=args.estimator)
